...
const BottomBar = ({ children }) => {
  ...
  return (
    <>
      ...
      <div
        className="md:hidden z-9999 fixed bottom-0 left-0 right-0 h-12 bg-bg2 text-white p-3 flex justify-around items-center shadow-md bg-opacity-90 backdrop-blur-md"
      >
        {/* Sidebar Icons */}
